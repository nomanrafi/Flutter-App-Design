      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 10),
            buildSpecialCard("Morning Gratitude", "5 min", "Good Morning", Colors.green[100]!, Colors.blue),
            SizedBox(height: 10),
            buildSpecialCard("Serenity Before Sleep", "7 min", "Good Evening", Colors.grey[200]!, Colors.grey),
          ],
        ),
      ),
